...
import com.at.common.binding.BaseBindingFragment
...
abstract class BaseMviFragment<VIEW: ViewBinding, VM: BaseAndroidViewModel<out IUiState,
        out IUiEvent, out IUiEffect>>: BaseBindingFragment<VIEW>() {
